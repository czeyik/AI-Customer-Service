...
| Real WhatsApp text, JPEG/PNG, MP4/3GP, duplicate and delivery checks | PASS: live text/JPEG/MP4, MIME/scan, ticket linkage, review and delivery/read passed; PNG/3GP content validation remains covered by the release suite |
